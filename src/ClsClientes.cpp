...
ClsClientes::mmenuClientes()
{
    ...
    do
    {
        ...
        case 2:
            {
                ...
                accion = "Ingreso a Cons. Clientes";
        ...
        case 4:
            {
                ...
                accion = "Ingreso a Impri. Clientes";
        ...
        case 5:
            {
                ...
                accion = "Ingreso a Elim. Clientes";
        ...
        case 6:
            {
                ...
                accion = "Ingreso a Buscar. Clientes";
        ...
        case 0:
            {
                accion = "Salio de Gestion Clientes";
